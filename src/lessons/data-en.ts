...
const WORD_BUCKETS_EN: string[][] = [
  ...
  [
    ...
    'carrot', 'potato', 'tomato', 'onion', 'pepper',
    'soccer', 'tennis', 'hockey', 'boxing', 'running',
    'guitar', 'piano', 'violin', 'drum', 'flute',
    'umbrella', 'wallet', 'mirror', 'towel', 'candle',
    'market', 'bank', 'museum', 'theater', 'station',
    'rabbit', 'monkey', 'panda', 'tiger', 'whale',
    'rainbow', 'thunder', 'cloud', 'storm', 'breeze',
    'pencil', 'eraser', 'folder', 'ruler', 'marker',
    'jacket', 'sweater', 'scarf', 'gloves', 'sandals',
    'orange', 'yellow', 'purple', 'silver', 'golden',
    'castle', 'bridge', 'tower', 'garden', 'harbor',
    'planet', 'rocket', 'comet', 'galaxy', 'meteor',
    'doctor', 'nurse', 'farmer', 'singer', 'writer',
  ],
]
