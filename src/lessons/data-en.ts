...
export const POSITION_STAGES_EN: PositionStage[] = [
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        title: '단어',
        lines: [
          'a sad lad', 'a fall', 'ask a lad', 'add a salad',
          'dad fall', 'a flask', 'ask dad', 'a dad', 'a flask falls',
          'salad falls', 'jak adds salad', 'all fall', 'a sad fall',
          'dad asks', 'a lass', 'a flask', 'fall fall',
        ],
      },
    ],
  },
    ...
    lessons: [
      {
        id: 'en-2.1',
        title: '글자',
        lines: ['g', 'h', 'gh', 'hg', 'ghj', 'fgh', 'gha', 'hag'],
      },
      {
        id: 'en-2.2',
        title: '단어',
        lines: [
          ...
          'half', 'gala', 'hall', 'hash', 'lash', 'dash',
          'flash', 'gash', 'shall', 'gaff', 'sag', 'shag',
          'jag', 'flag', 'flagg', 'hash', 'gala',
        ],
      },
      {
        id: 'en-2.3',
    ...
    lessons: [
      ...
      },
      {
        ...
        lines: [
          ...
          'were', 'their', 'there', 'here', 'where', 'every',
    ...
    lessons: [
      ...
      },
      {
        ...
        lines: [
          ...
          'now', 'new', 'know', 'come', 'some', 'time',
          'name', 'much', 'most', 'made', 'mean',
          'box', 'fix', 'mix', 'six', 'tax',
  ...
  },
  {
    id: 7,
    title: '7단계 — 기호 · 전체',
    description: '쉼표, 마침표, 따옴표, 물음표 등 자주 쓰는 기호와 전체 종합 연습.',
    lessons: [
      {
        id: 'en-7.1',
        title: '기호',
      ...
      },
      {
        ...
        lines: [
          ...
          'Knowledge is power; reading is its source.',
